...
<div id="main-container"> 
    ...
    <form id="quickregisterform" method="post" action="..//quickregister/age_gate_submit"> 
        ...
        <div id="date-selector"> 
            <div id="agegate-notice"><span style="font-size:12px; color: #00ccff;">Der Ordner 'install' wurde noch nicht gel&ouml;scht!</span></div> 
			<p>Bevor sie ShorsideCMS verwenden k&ouml;nnen muss der Ordner 'install' in ihrem Webordner gel&ouml;scht werden. Ansonsten kann jeder mit dem Link zu diesem Ordner ihr Hotel zur&uuml;cksetzen. L&ouml;schen sie den Ordner.</p>
