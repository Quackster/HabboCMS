...
<div id="stepnumbers"> 
    ...
    <div class="step3focus">Client Einrichtung</div> 
...
<div id="main-container"> 
    ...
    <form id="quickregisterform" method="post" action="..//quickregister/age_gate_submit"> 
        ...
        <div id="date-selector"> 
            <div id="agegate-notice"><span style="font-size:12px; color: #00ccff;">Loggen sie sich in das Housekeeping ein!</span></div> 
			<p>Stellen sie sich einen Adminaccount ein und bearbeiten sie unter Hotel alle werte f&uuml;r ihren Clienten. Derzeitige SWF von images.lukadora.de ist ab Werk in der Datenabnk von Ultimate eingestellt.</p>
        ...
        <div id="inner-container"> 
            <h3>Wie mache ich mich zum Admin? ( XAMPP Nutzer )</h3>
			<li>- Logge dich unter http://localhost/phpmyadmin ein</li>
			<li>- Gehe in deine Datenbank und die Tabelle users</li>
			<li>- Klicke bei deinem Namen auf Bearbeiten</li>
			<li>- Stelle bei rank die Zahl 7 ein und speicher ab</li>
        </div> 
    </form> 
 
    <div id="select"> 
        <a id="back-link" href="step4.php">Nicht registrieren und beenden!</a> 
        <div class="button"> 
            <a id="proceed" href="step4.php" class="area">User Registrieren</a> 
