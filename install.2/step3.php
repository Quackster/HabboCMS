        ...
        <div id="main-container">
            <form id="quickregisterform" method="post" action="..//quickregister/age_gate_submit">
                ...
                <div id="date-selector">
                    <div id="agegate-notice"><span style="font-size:12px; color: #00ccff;">Loggen sie sich in das Housekeeping ein!</span>
                    </div>
                    <p>Stellen sie sich einen Adminaccount ein und bearbeiten sie unter Hotel alle werte f&uuml;r ihren
                       Clienten. Derzeitige SWF von images.lukadora.de ist ab Werk in der Datenabnk von Ultimate
                       eingestellt.</p>
                </div>
