...
<script type="text/javascript" src="<?php echo WWW; ?>/manage/js/tiny_mce/tinymce.min.js"></script>
<script type="text/javascript">
tinyMCE.init({
	mode : "exact",
	elements : "content",
...
<h2>Adicionar nova promoção</h2>  <img src="images/typo.gif" style="float: right;">
