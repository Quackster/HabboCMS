...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">External texts (overrides)</h1>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	<!-- /.row -->
		...
		<div class="col-lg-12">
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<p>This tool can be used to override external texts keys.</p>
				</div>
				<!-- /.panel-body -->
			</div>
			<!-- /.panel -->
			<div class="panel panel-default">
				...
				<!-- /.panel-heading -->
				<div class="panel-body">
					<a href="http://hotel-uk.habbo.com/gamedata/external?id=external_flash_texts" id="">Show Habbo\'s external texts</a>
				</div>
				<!-- /.panel-body -->
			</div>
			<!-- /.panel -->
								...
								while ($text = mysql_fetch_assoc($get))
								{
									echo '<tr>
											<form method="post">
												...
												<td><center><button type="submit" class="btn btn-outline btn-success">Update</button>&nbsp;<input type="button" class="btn btn-outline btn-danger" value="Delete" onClick="window.location = \'?p=texts&doDel='. $text['skey'] .'\';"></center></td>
											</form>
										</tr>';
								}
