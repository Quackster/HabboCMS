    ...
    public function addIncludeSet($set)
    {
        switch (strtolower($set)) {
            case 'frontpage':
                ...
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/static/styles/frontpage.css',
                    'stylesheet'));
                break;
            ...
            case 'maintenance':
                ...
                $this->addIncludeFile(new IncludeFile('text/css',
                    'http://images.habbo.com/habboweb/%web_build%/web-gallery/static/styles/frontpage.css',
                    'stylesheet'));
            ...
            case 'register':
                ...
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/v2/styles/style.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/v2/styles/buttons.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/v2/styles/boxes.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/v2/styles/tooltips.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/v2/styles/changepassword.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/v2/styles/forcedemaillogin.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/v2/styles/quickregister.css',
                    'stylesheet'));
                break;
            ...
            case 'process-template':
                ...
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/v2/styles/tooltips.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/v2/styles/process.css',
                    'stylesheet'));
                break;
            ...
            case 'myhabbo':
                ...
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/v2/styles/tooltips.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/styles/myhabbo/myhabbo.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/styles/myhabbo/skins.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/styles/myhabbo/dialogs.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/styles/myhabbo/buttons.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css',
                    '%www%/web-gallery/styles/myhabbo/control.textarea.css', 'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/styles/myhabbo/boxes.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/v2/styles/myhabbo.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/css', 'http://www.habbo.co.uk/myhabbo/styles/assets.css',
                    'stylesheet'));
                $this->addIncludeFile(new IncludeFile('text/javascript', '%www%/web-gallery/static/js/homeview.js'));
                $this->addIncludeFile(new IncludeFile('text/css', '%www%/web-gallery/v2/styles/lightwindow.css',
                    'stylesheet'));
                break;
...
class Template
{
    ...
    public function getHtml()
    {
        ...
        $file = ROOT . '/inc/tpl/' . $this->tplName . '.php';
